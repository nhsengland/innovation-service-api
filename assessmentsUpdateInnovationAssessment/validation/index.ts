...
const payloadSchema = Joi.object({
  ...
  maturityLevelComment: Joi.string()
    .max(constants.smallFieldCharacterLimit)
    .allow(null)
    .allow("")
    .optional(),
  ...
  hasScaleResourceComment: Joi.string()
    .max(constants.smallFieldCharacterLimit)
    .allow(null)
    .allow("")
    .optional(),
