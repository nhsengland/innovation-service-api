...
describe("assessmentUsersInnovationRecordSubmitedHandler suite", () => {
  beforeAll(() => {
    dotenv.config({
  ...
  it("should throw InvalidEmailTemplateProps", async () => {
    ...
    try {
      await handlers.assessmentUsersInnovationRecordSubmitedHandler(
        reqUser,
        params,
        template,
        ["user_id"],
  ...
  it("should Send email with the correct handler", async () => {
    ...
    let result;
    try {
      result = await handlers.assessmentUsersInnovationRecordSubmitedHandler(
        reqUser,
        params,
        template,
        ["user_id"],
