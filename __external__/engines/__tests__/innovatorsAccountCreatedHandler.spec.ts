...
describe("innovatorsAccountCreatedHandler suite", () => {
  beforeAll(() => {
    dotenv.config({
  ...
  it("should throw InvalidEmailTemplateProps", async () => {
    ...
    const template = EmailNotificationTemplate.INNOVATORS_ACCOUNT_CREATED;

    let err: InvalidEmailTemplateProps;
    try {
      await handlers.innovatorsAccountCreatedHandler(
        reqUser,
        params,
        template,
        ["user_id"],
  ...
  it("should Send email with the correct handler", async () => {
    ...
    const params = {
      ...
      contextId: "_context_id",
      emailProps: {
        innovation_service_url: "innovation_service_url",
      },
    };
    ...
    let result;
    try {
      result = await handlers.innovatorsAccountCreatedHandler(
        reqUser,
        params,
        template,
        ["user_id"],
