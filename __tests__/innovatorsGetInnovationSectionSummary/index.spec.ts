...
describe("[HttpTrigger] innovatorsGetInnovation Suite", () => {
  describe("Function Handler", () => {
    ...
    it("Should return 200 when Innovations and sections are found", async () => {
      ...
      ).mockResolvedValue([{ innovation: "test_innovator_id" }] as any);
    ...
    it("Should return 403 when innovator has an invalid user type", async () => {
      ...
      jest.spyOn(persistence, "findAllInnovationSectionsMetadata").mockResolvedValue([
    ...
    [
      {
        ...
        data: createHttpTrigger(
          "GET",
          "http://nhse-i-aac/api/innovators/{userId}/innovations/{innovationId}/section-summary",
