...
describe("[HttpTrigger] innovatorsSubmitInnovationSection Suite", () => {
  describe("Function Handler", () => {
    ...
    it("Should return 204 when Innovation sections are submitted", async () => {
      ...
      jest.spyOn(persistence, "submitInnovationSections").mockResolvedValue([{}] as any);
    ...
    it("Should handle error persistence return error", async () => {
      ...
      jest.spyOn(persistence, "submitInnovationSections").mockRejectedValue(
        "Error."
      );
    ...
    [
      {
        ...
        data: createHttpTrigger(
          "PATCH",
          "http://nhse-i-aac/api/innovators/{userId}/innovations/{innovationId}/sections/submit",
