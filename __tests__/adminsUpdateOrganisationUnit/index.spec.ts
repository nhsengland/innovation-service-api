...
import adminsUpdateOrganisationUnit from "../../adminsUpdateOrganisationUnit";
import * as persistence from "../../adminsUpdateOrganisationUnit/persistence";
import * as validation from "../../adminsUpdateOrganisationUnit/validation";
...
describe("[HttpTrigger] adminsUpdateOrganisationUnit Suite", () => {
    describe("Function Handler", () => {
        ...
        it("Should handle error persistence return error", async () => {
            ...
            jest.spyOn(persistence, "updateOrganisationUnit").mockRejectedValue(
                "Error."
            );
