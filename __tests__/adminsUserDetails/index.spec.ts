...
import adminsUserDetails from "../../adminsUserDetails";
...
describe("[HttpTrigger] adminsUserDetails Suite", () => {
    describe("Function Handler", () => {
        ...
        it("Should return 200 on successful completion", async () => {
            ...
            jest.spyOn(persistence, "getUser").mockResolvedValue({
                id: ":userId",
                name: ":userName",
            } as any);
        ...
        it("Should handle error persistence return error", async () => {
            ...
            jest.spyOn(persistence, "getUser").mockRejectedValue(
                "Error."
            );
        ...
        [
            {
                ...
                data: createHttpTrigger(
                    "GET",
                    "http://nhse-i-aac/api/user-admin/users/{userId}",
                    { ...data.headers }, // headers
                    { userId: dummy.accessorId },
                    null, // payload/body
                    { model: "MINIMAL" }, // querystring
                ),
            },
