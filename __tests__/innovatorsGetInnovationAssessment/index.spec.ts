...
import innovatorsGetInnovationAssessment from "../../innovatorsGetInnovationAssessment";
...
const dummy = {
  ...
  innovatorId: "test_assessment_user_id",
...
describe("[HttpTrigger] innovatorsGetInnovationAssessment Suite", () => {
  describe("Function Handler", () => {
    ...
    it("Should handle error persistence return error", async () => {
      ...
      spyOn(persistence, "findInnovationAssessmentById").and.throwError(
        "Error."
      );
...
async function mockedRequestFactory(data?: any) {
  return runStubFunctionFromBindings(
    innovatorsGetInnovationAssessment,
    [
      {
        type: "httpTrigger",
        name: "req",
        ...
        data: createHttpTrigger(
          "GET",
          "http://nhse-i-aac/api/innovators/{userId}/innovations/{innovationId}/assessments/{assessmentId}",
