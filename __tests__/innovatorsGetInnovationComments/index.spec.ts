...
import innovatorsGetInnovationComments from "../../innovatorsGetInnovationComments";
...
describe("[HttpTrigger] innovatorsGetInnovationComments Suite", () => {
...
async function mockedRequestFactory(data?: any) {
  return runStubFunctionFromBindings(
    innovatorsGetInnovationComments,
    [
      {
        type: "httpTrigger",
        name: "req",
        ...
        data: createHttpTrigger(
          "GET",
          "http://nhse-i-aac/api/innovators/{innovatorId}/innovations/{innovationId}/comments",
