...
import innovatorsGetInnovationSupportLogs from "../../innovatorsGetInnovationSupportLogs";
...
describe("[HttpTrigger] innovatorsGetInnovationSupportLogs Suite", () => {
...
async function mockedRequestFactory(data?: any) {
  return runStubFunctionFromBindings(
    innovatorsGetInnovationSupportLogs,
    [
      {
        type: "httpTrigger",
        name: "req",
        ...
        data: createHttpTrigger(
          "GET",
          "http://nhse-i-aac/api/innovators/{userId}/innovations/{innovationId}/support-logs",
