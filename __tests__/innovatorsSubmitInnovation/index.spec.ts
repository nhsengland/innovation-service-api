...
describe("[HttpTrigger] innovatorsSubmitInnovation Suite", () => {
  describe("Function Handler", () => {
    ...
    it("Should return 200 when Innovation sections are submitted", async () => {
      jest.spyOn(connection, "setupSQLConnection").mockResolvedValue(null);
      jest.spyOn(service_loader, "loadAllServices").mockResolvedValue(dummy.services as any);
      jest.spyOn(authentication, "decodeToken").mockReturnValue({
        oid: "test_innovator_id",
      });
      jest.spyOn(persistence, "submitInnovation").mockResolvedValue([{}] as any);
    ...
    it("Should handle error persistence return error", async () => {
      ...
      jest.spyOn(persistence, "submitInnovation").mockRejectedValue(
        "Error."
      );
    ...
    [
      {
        ...
        data: createHttpTrigger(
          "PATCH",
          "http://nhse-i-aac/api/innovators/{userId}/innovations/{innovationId}/submit",
