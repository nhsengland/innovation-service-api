...
describe("[HttpTrigger] accessorsGetAllActions Suite", () => {
  describe("Function Handler", () => {
    ...
    beforeAll(()=> {
      ...
      //jest.spyOn(decorators, "OrganisationRoleValidator").mockReturnThis();
    ...
    it("Should return 200 when Innovation Actions is found", async () => {
      ...
      jest.spyOn(persistence, "findAllActions").mockResolvedValue([
        { id: ":action_id" },
      ] as any);
    ...
    it("Should handle error persistence return error", async () => {
      ...
      jest.spyOn(persistence, "findAllActions").mockRejectedValue(
        "Error."
      );
    ...
    [
      {
        ...
        data: createHttpTrigger(
          "GET",
          "http://nhse-i-aac/api/accessors/{userId}/actions",
