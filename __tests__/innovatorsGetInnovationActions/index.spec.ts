...
import innovatorsGetInnovationActions from "../../innovatorsGetInnovationActions";
...
describe("[HttpTrigger] innovatorsGetInnovationActions Suite", () => {
  describe("Function Handler", () => {
    ...
    it("Should return 200 when Innovation Actions is found", async () => {
      ...
      spyOn(persistence, "findInnovationActions").and.returnValue([
        { id: ":action_id" },
      ]);
    ...
    it("Should handle error persistence return error", async () => {
      ...
      spyOn(persistence, "findInnovationActions").and.throwError(
        "Error."
      );
...
async function mockedRequestFactory(data?: any) {
  return runStubFunctionFromBindings(
    innovatorsGetInnovationActions,
    [
      {
        type: "httpTrigger",
        name: "req",
        ...
        data: createHttpTrigger(
          "GET",
          "http://nhse-i-aac/api/innovators/{userId}/innovations/{innovationId}/actions",
