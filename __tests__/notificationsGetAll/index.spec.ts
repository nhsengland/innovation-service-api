...
import notificationsGetAll from '../../notificationsGetAll'
...
describe("[HttpTrigger] notificationsGetAll Suite", () => {
  describe("Function Handler", () => {
    ...
    it("Should return 200 when notifications are found", async () => {

      jest.spyOn(authentication, 'decodeToken').mockReturnValue({oid: ':oid'});
      jest.spyOn(connection, "setupSQLConnection").mockResolvedValue(null);
      jest.spyOn(service_loader, "loadAllServices").mockResolvedValue(dummy.services as any);

      jest.spyOn(persistence, "getNotificationsByUserId").mockResolvedValue([
        { },
      ] as any);
