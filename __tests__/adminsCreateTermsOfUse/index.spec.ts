...
import adminsCreateTermsOfUse from "../../adminsCreateTermsOfUse";
import * as persistence from "../../adminsCreateTermsOfUse/persistence";
import * as validation from "../../adminsCreateTermsOfUse/validation";
...
describe("[HttpTrigger] adminsCreateTermsOfUse Suite", () => {
  describe("Function Handler", () => {
    ...
    it("Should return 200 when user is created", async () => {
      ...
      jest.spyOn(persistence, "createTermsOfUse").mockResolvedValue({ name : ":userId" } as any);
    ...
    it("Should handle error persistence return error", async () => {
      ...
      jest.spyOn(persistence, "createTermsOfUse").mockRejectedValue(
        "Error."
      );
