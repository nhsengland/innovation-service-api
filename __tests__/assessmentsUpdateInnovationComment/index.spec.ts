...
import assessmentsUpdateInnovationComment from "../../assessmentsUpdateInnovationComment";
import * as persistence from "../../assessmentsUpdateInnovationComment/persistence";
import * as validation from "../../assessmentsUpdateInnovationComment/validation";
...
describe("[HttpTrigger] assessmentsUpdateInnovationComment Suite", () => {
...
async function mockedRequestFactory(data?: any) {
  return runStubFunctionFromBindings(
    assessmentsUpdateInnovationComment,
    [
      {
        type: "httpTrigger",
        name: "req",
        ...
        data: createHttpTrigger(
          "PUT",
          "http://nhse-i-aac/api/assessments/{userId}/innovations/{innovationId}/comments/{commentId}",
