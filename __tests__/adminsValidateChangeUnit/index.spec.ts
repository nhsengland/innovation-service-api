...
import adminsUpdateUsers from "../../adminsValidateChangeUnit";
...
describe("[HttpTrigger] adminsValidateChangeUnit Suite", () => {
  describe("Function Handler", () => {
    ...
    it("Should return 200 when runs without Internal Server Errors", async () => {
      ...
      jest.spyOn(persistence, "changeUnitValidation").mockResolvedValue({ id: ":userId" } as any);
    ...
    it("Should handle error persistence return error", async () => {
      ...
      jest.spyOn(persistence, "changeUnitValidation").mockRejectedValue(
        "Error."
      );
